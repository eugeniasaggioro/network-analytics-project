                                               ...
                                               dashboardBody(
                                                 wellPanel(
                                                   fluidRow(
                                                     column(12, h3("Key features of our book dataset"),
                                                            ...
                                                            column(2, valueBox(p(min(dt.Complete.Books$Year_of_Publication), max(dt.Complete.Books$Year_of_Publication)),
                                                 ...
                                                 fluidRow(column(6, 
                                                          ...
                                                          column(6, 
                                                                 ...
                                                                 helpText("On a scale from 1-10, our users'average rating is below the mean."),
